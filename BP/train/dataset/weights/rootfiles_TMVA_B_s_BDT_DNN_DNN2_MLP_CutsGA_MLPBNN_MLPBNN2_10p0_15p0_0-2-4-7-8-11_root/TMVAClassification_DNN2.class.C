...
Layout: "TANH|256,TANH|256,TANH|128,TANH|128,LINEAR" [Layout of the network.]
...
class ReadDNN2 : public IClassifierReader {

 public:

   // constructor
   ReadDNN2( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadDNN2" ),
        fNvars( 6 ),
        fIsNormalised( false )
 ...
 private:
   ...
   inline double ReadDNN2::GetMvaValue( const std::vector<double>& inputValues ) const
   {
...
inline void ReadDNN2::InitTransform_1()
{
...
//_______________________________________________________________________
inline void ReadDNN2::Transform_1( std::vector<double>& iv, int cls) const
{
...
//_______________________________________________________________________
inline void ReadDNN2::InitTransform()
{
   InitTransform_1();
}

//_______________________________________________________________________
inline void ReadDNN2::Transform( std::vector<double>& iv, int sigOrBgd ) const
{
