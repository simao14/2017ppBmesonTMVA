...
int split_jpsi()
{
  ...
  TString inputSname ="/raid5/data/wangj/BntupleRun2018/ntKp_Bfinder_20220519_BJPsiMM_mc2017_realistic_forppRef5TeV_trk0p5Bpt5_Bgen23335.root";
  ...
  for (unsigned i = 0; i < ptbins.size() - 1; ++i) {
    ...
    auto outname = TString::Format("../sample/jpsinp_pre_%.0f_%.0f.root", ptbins[i], ptbins[i+1]);
